...
namespace CommonLib.Implementations
{
    ...
    static public class CS6GFactory
    {
        ...
        static public CErrorLogger GetErrorLoggerInstance()
        {
            lock (_locker)
            {
                if (_cErrorLogger == null)
                {
                    ...
                    _cErrorLogger = new CErrorLogger(configuration);
                }
        ...
        /// <param name="configuration"></param>
        /// <returns></returns>
        static public CSqlLogger GetSqlLoggerInstance()
        {
            lock (_locker)
            {
                if (_cSqlLogger == null)
                {
                    ...
                    _cSqlLogger = new CSqlLogger(configuration);
                }
		...
		/// <param name="configuration"></param>
		/// <returns></returns>
		static public CInfoLogger GetInfoLoggerInstance()
		{
			lock (_locker)
			{
				if (_cInfoLogger == null)
				{
					...
					_cInfoLogger = new CInfoLogger(configuration);
				}
		...
		/// <returns></returns>
		static public CCommon GetCommonInstance()
        {
            lock (_locker)
            {
                //if (_cCommon == null)
        ...
        /// </summary>
        /// <returns></returns>
        static public CMonitor GetMonitorInstance()
        {
            lock (_locker)
            {
                if (_cMonitor == null)
